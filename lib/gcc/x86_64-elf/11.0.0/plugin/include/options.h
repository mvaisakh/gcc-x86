...
enum opt_code
{
  ...
  OPT_list = 1666,                           /* -list */
  OPT_m128bit_long_double = 1667,            /* -m128bit-long-double */
  OPT_m16 = 1668,                            /* -m16 */
  OPT_m32 = 1669,                            /* -m32 */
  OPT_m3dnow = 1670,                         /* -m3dnow */
  OPT_m3dnowa = 1671,                        /* -m3dnowa */
  OPT_m64 = 1672,                            /* -m64 */
  OPT_m80387 = 1673,                         /* -m80387 */
  OPT_m8bit_idiv = 1674,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1675,             /* -m96bit-long-double */
  OPT_mabi_ = 1676,                          /* -mabi= */
  OPT_mabm = 1677,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1678,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1679,                 /* -maddress-mode= */
  OPT_madx = 1680,                           /* -madx */
  OPT_maes = 1681,                           /* -maes */
  OPT_malign_data_ = 1682,                   /* -malign-data= */
  OPT_malign_double = 1683,                  /* -malign-double */
  OPT_malign_functions_ = 1684,              /* -malign-functions= */
  OPT_malign_jumps_ = 1685,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1686,                  /* -malign-loops= */
  OPT_malign_stringops = 1687,               /* -malign-stringops */
  OPT_mamx_bf16 = 1688,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1689,                      /* -mamx-int8 */
  OPT_mamx_tile = 1690,                      /* -mamx-tile */
  OPT_march_ = 1691,                         /* -march= */
  OPT_masm_ = 1692,                          /* -masm= */
  OPT_mavx = 1693,                           /* -mavx */
  OPT_mavx2 = 1694,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1695,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1696,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1697,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1698,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1699,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1700,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1701,                      /* -mavx512bw */
  OPT_mavx512cd = 1702,                      /* -mavx512cd */
  OPT_mavx512dq = 1703,                      /* -mavx512dq */
  OPT_mavx512er = 1704,                      /* -mavx512er */
  OPT_mavx512f = 1705,                       /* -mavx512f */
  OPT_mavx512ifma = 1706,                    /* -mavx512ifma */
  OPT_mavx512pf = 1707,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1708,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1709,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1710,                      /* -mavx512vl */
  OPT_mavx512vnni = 1711,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1712,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1713,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1714,                       /* -mavxvnni */
  OPT_mbmi = 1715,                           /* -mbmi */
  OPT_mbmi2 = 1716,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1717,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1718,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1719,                    /* -mcet-switch */
  OPT_mcld = 1720,                           /* -mcld */
  OPT_mcldemote = 1721,                      /* -mcldemote */
  OPT_mclflushopt = 1722,                    /* -mclflushopt */
  OPT_mclwb = 1723,                          /* -mclwb */
  OPT_mclzero = 1724,                        /* -mclzero */
  OPT_mcmodel_ = 1725,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1726, */                    /* -mcpu= */
  OPT_mcrc32 = 1727,                         /* -mcrc32 */
  OPT_mcx16 = 1728,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1729,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1730,            /* -mdump-tune-features */
  OPT_menqcmd = 1731,                        /* -menqcmd */
  OPT_mf16c = 1732,                          /* -mf16c */
  OPT_mfancy_math_387 = 1733,                /* -mfancy-math-387 */
  OPT_mfentry = 1734,                        /* -mfentry */
  OPT_mfentry_name_ = 1735,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1736,               /* -mfentry-section= */
  OPT_mfma = 1737,                           /* -mfma */
  OPT_mfma4 = 1738,                          /* -mfma4 */
  OPT_mforce_drap = 1739,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1740,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1741,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1742,                       /* -mfpmath= */
  OPT_mfsgsbase = 1743,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1744,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1745, */              /* -mfused-madd */
  OPT_mfxsr = 1746,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1747,             /* -mgeneral-regs-only */
  OPT_mgfni = 1748,                          /* -mgfni */
  OPT_mhard_float = 1749,                    /* -mhard-float */
  OPT_mhle = 1750,                           /* -mhle */
  OPT_mhreset = 1751,                        /* -mhreset */
  OPT_miamcu = 1752,                         /* -miamcu */
  OPT_mieee_fp = 1753,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1754,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1755,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1756,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1757,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1758,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1759,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1760, */            /* -mintel-syntax */
  OPT_mkl = 1761,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1762,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1763,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1764,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1765,                /* -mlong-double-80 */
  OPT_mlwp = 1766,                           /* -mlwp */
  OPT_mlzcnt = 1767,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1768,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1769,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1770,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1771,                  /* -mmitigate-rop */
  OPT_mmmx = 1772,                           /* -mmmx */
  OPT_mmovbe = 1773,                         /* -mmovbe */
  OPT_mmovdir64b = 1774,                     /* -mmovdir64b */
  OPT_mmovdiri = 1775,                       /* -mmovdiri */
  OPT_mmpx = 1776,                           /* -mmpx */
  OPT_mms_bitfields = 1777,                  /* -mms-bitfields */
  OPT_mmwaitx = 1778,                        /* -mmwaitx */
  OPT_mneeded = 1779,                        /* -mneeded */
  OPT_mno_align_stringops = 1780,            /* -mno-align-stringops */
  OPT_mno_default = 1781,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1782,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1783,                  /* -mno-push-args */
  OPT_mno_red_zone = 1784,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1785,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1786,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1787,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1788,                          /* -mpc32 */
  OPT_mpc64 = 1789,                          /* -mpc64 */
  OPT_mpc80 = 1790,                          /* -mpc80 */
  OPT_mpclmul = 1791,                        /* -mpclmul */
  OPT_mpcommit = 1792,                       /* -mpcommit */
  OPT_mpconfig = 1793,                       /* -mpconfig */
  OPT_mpku = 1794,                           /* -mpku */
  OPT_mpopcnt = 1795,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1796, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1797,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1798,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1799,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1800,                        /* -mprfchw */
  OPT_mptwrite = 1801,                       /* -mptwrite */
  OPT_mpush_args = 1802,                     /* -mpush-args */
  OPT_mrdpid = 1803,                         /* -mrdpid */
  OPT_mrdrnd = 1804,                         /* -mrdrnd */
  OPT_mrdseed = 1805,                        /* -mrdseed */
  OPT_mrecip = 1806,                         /* -mrecip */
  OPT_mrecip_ = 1807,                        /* -mrecip= */
  OPT_mrecord_mcount = 1808,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1809,                 /* -mrecord-return */
  OPT_mred_zone = 1810,                      /* -mred-zone */
  OPT_mregparm_ = 1811,                      /* -mregparm= */
  OPT_mrtd = 1812,                           /* -mrtd */
  OPT_mrtm = 1813,                           /* -mrtm */
  OPT_msahf = 1814,                          /* -msahf */
  OPT_mserialize = 1815,                     /* -mserialize */
  OPT_msgx = 1816,                           /* -msgx */
  OPT_msha = 1817,                           /* -msha */
  OPT_mshstk = 1818,                         /* -mshstk */
  OPT_mskip_rax_setup = 1819,                /* -mskip-rax-setup */
  OPT_msoft_float = 1820,                    /* -msoft-float */
  OPT_msse = 1821,                           /* -msse */
  OPT_msse2 = 1822,                          /* -msse2 */
  OPT_msse2avx = 1823,                       /* -msse2avx */
  OPT_msse3 = 1824,                          /* -msse3 */
  OPT_msse4 = 1825,                          /* -msse4 */
  OPT_msse4_1 = 1826,                        /* -msse4.1 */
  OPT_msse4_2 = 1827,                        /* -msse4.2 */
  OPT_msse4a = 1828,                         /* -msse4a */
  /* OPT_msse5 = 1829, */                    /* -msse5 */
  OPT_msseregparm = 1830,                    /* -msseregparm */
  OPT_mssse3 = 1831,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1832,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1833, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1834,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1835, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1836,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1837,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1838,            /* -mstringop-strategy= */
  OPT_mstv = 1839,                           /* -mstv */
  OPT_mtbm = 1840,                           /* -mtbm */
  OPT_mtls_dialect_ = 1841,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1842,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1843,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1844,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1845,                         /* -mtune= */
  OPT_muintr = 1846,                         /* -muintr */
  OPT_mvaes = 1847,                          /* -mvaes */
  OPT_mveclibabi_ = 1848,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1849,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1850,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1851,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1852,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1853,                      /* -mwbnoinvd */
  OPT_mwidekl = 1854,                        /* -mwidekl */
  OPT_mx32 = 1855,                           /* -mx32 */
  OPT_mxop = 1856,                           /* -mxop */
  OPT_mxsave = 1857,                         /* -mxsave */
  OPT_mxsavec = 1858,                        /* -mxsavec */
  OPT_mxsaveopt = 1859,                      /* -mxsaveopt */
  OPT_mxsaves = 1860,                        /* -mxsaves */
  OPT_n = 1861,                              /* -n */
  OPT_name_sort = 1862,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1863,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1864,              /* -no-integrated-cpp */
  OPT_no_pie = 1865,                         /* -no-pie */
  OPT_nocpp = 1866,                          /* -nocpp */
  OPT_nodefaultlibs = 1867,                  /* -nodefaultlibs */
  OPT_nolibc = 1868,                         /* -nolibc */
  OPT_nophoboslib = 1869,                    /* -nophoboslib */
  OPT_nostartfiles = 1870,                   /* -nostartfiles */
  OPT_nostdinc = 1871,                       /* -nostdinc */
  OPT_nostdinc__ = 1872,                     /* -nostdinc++ */
  OPT_nostdlib = 1873,                       /* -nostdlib */
  OPT_o = 1874,                              /* -o */
  OPT_objects = 1875,                        /* -objects */
  OPT_p = 1876,                              /* -p */
  OPT_pass_exit_codes = 1877,                /* -pass-exit-codes */
  /* OPT_pedantic = 1878, */                 /* -pedantic */
  OPT_pedantic_errors = 1879,                /* -pedantic-errors */
  OPT_pg = 1880,                             /* -pg */
  OPT_pie = 1881,                            /* -pie */
  OPT_pipe = 1882,                           /* -pipe */
  OPT_print_file_name_ = 1883,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1884,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1885,          /* -print-multi-directory */
  OPT_print_multi_lib = 1886,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1887,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1888,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1889,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1890,               /* -print-prog-name= */
  OPT_print_search_dirs = 1891,              /* -print-search-dirs */
  OPT_print_sysroot = 1892,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1893,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1894,                    /* -print-value */
  OPT_quiet = 1895,                          /* -quiet */
  OPT_r = 1896,                              /* -r */
  ...
  OPT_static_libstdc__ = 1918,               /* -static-libstdc++ */
  OPT_static_libtsan = 1919,                 /* -static-libtsan */
  OPT_static_libubsan = 1920,                /* -static-libubsan */
  OPT_static_pie = 1921,                     /* -static-pie */
  /* OPT_std_c__03 = 1922, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1923, */                /* -std=c++0x */
  OPT_std_c__11 = 1924,                      /* -std=c++11 */
  OPT_std_c__14 = 1925,                      /* -std=c++14 */
  OPT_std_c__17 = 1926,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1927, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1928, */                /* -std=c++1z */
  OPT_std_c__20 = 1929,                      /* -std=c++20 */
  OPT_std_c__23 = 1930,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1931, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1932, */                /* -std=c++2b */
  OPT_std_c__98 = 1933,                      /* -std=c++98 */
  OPT_std_c11 = 1934,                        /* -std=c11 */
  OPT_std_c17 = 1935,                        /* -std=c17 */
  /* OPT_std_c18 = 1936, */                  /* -std=c18 */
  /* OPT_std_c1x = 1937, */                  /* -std=c1x */
  OPT_std_c2x = 1938,                        /* -std=c2x */
  /* OPT_std_c89 = 1939, */                  /* -std=c89 */
  OPT_std_c90 = 1940,                        /* -std=c90 */
  OPT_std_c99 = 1941,                        /* -std=c99 */
  /* OPT_std_c9x = 1942, */                  /* -std=c9x */
  OPT_std_f2003 = 1943,                      /* -std=f2003 */
  OPT_std_f2008 = 1944,                      /* -std=f2008 */
  OPT_std_f2008ts = 1945,                    /* -std=f2008ts */
  OPT_std_f2018 = 1946,                      /* -std=f2018 */
  OPT_std_f95 = 1947,                        /* -std=f95 */
  OPT_std_gnu = 1948,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1949, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1950, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1951,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1952,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1953,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1954, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1955, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1956,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1957,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1958, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1959, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1960,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1961,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1962,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1963, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1964, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1965,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1966, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1967,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1968,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1969, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1970, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1971,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1972, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1973, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1974, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1975, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1976, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1977,                     /* -std=legacy */
  OPT_stdlib_ = 1978,                        /* -stdlib= */
  OPT_symbol_ = 1979,                        /* -symbol= */
  OPT_symbolic = 1980,                       /* -symbolic */
  OPT_t = 1981,                              /* -t */
  OPT_time = 1982,                           /* -time */
  OPT_time_ = 1983,                          /* -time= */
  OPT_traditional = 1984,                    /* -traditional */
  OPT_traditional_cpp = 1985,                /* -traditional-cpp */
  OPT_tree_stats = 1986,                     /* -tree-stats */
  OPT_trigraphs = 1987,                      /* -trigraphs */
  OPT_type_stats = 1988,                     /* -type-stats */
  OPT_u = 1989,                              /* -u */
  OPT_undef = 1990,                          /* -undef */
  OPT_v = 1991,                              /* -v */
  OPT_version = 1992,                        /* -version */
  OPT_w = 1993,                              /* -w */
  OPT_wrapper = 1994,                        /* -wrapper */
  OPT_x = 1995,                              /* -x */
  OPT_z = 1996,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
