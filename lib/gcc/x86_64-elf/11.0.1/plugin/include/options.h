...
enum opt_code
{
  ...
  OPT_list = 1672,                           /* -list */
  OPT_m128bit_long_double = 1673,            /* -m128bit-long-double */
  OPT_m16 = 1674,                            /* -m16 */
  OPT_m32 = 1675,                            /* -m32 */
  OPT_m3dnow = 1676,                         /* -m3dnow */
  OPT_m3dnowa = 1677,                        /* -m3dnowa */
  OPT_m64 = 1678,                            /* -m64 */
  OPT_m80387 = 1679,                         /* -m80387 */
  OPT_m8bit_idiv = 1680,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1681,             /* -m96bit-long-double */
  OPT_mabi_ = 1682,                          /* -mabi= */
  OPT_mabm = 1683,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1684,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1685,                 /* -maddress-mode= */
  OPT_madx = 1686,                           /* -madx */
  OPT_maes = 1687,                           /* -maes */
  OPT_malign_data_ = 1688,                   /* -malign-data= */
  OPT_malign_double = 1689,                  /* -malign-double */
  OPT_malign_functions_ = 1690,              /* -malign-functions= */
  OPT_malign_jumps_ = 1691,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1692,                  /* -malign-loops= */
  OPT_malign_stringops = 1693,               /* -malign-stringops */
  OPT_mamx_bf16 = 1694,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1695,                      /* -mamx-int8 */
  OPT_mamx_tile = 1696,                      /* -mamx-tile */
  OPT_march_ = 1697,                         /* -march= */
  OPT_masm_ = 1698,                          /* -masm= */
  OPT_mavx = 1699,                           /* -mavx */
  OPT_mavx2 = 1700,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1701,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1702,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1703,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1704,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1705,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1706,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1707,                      /* -mavx512bw */
  OPT_mavx512cd = 1708,                      /* -mavx512cd */
  OPT_mavx512dq = 1709,                      /* -mavx512dq */
  OPT_mavx512er = 1710,                      /* -mavx512er */
  OPT_mavx512f = 1711,                       /* -mavx512f */
  OPT_mavx512ifma = 1712,                    /* -mavx512ifma */
  OPT_mavx512pf = 1713,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1714,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1715,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1716,                      /* -mavx512vl */
  OPT_mavx512vnni = 1717,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1718,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1719,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1720,                       /* -mavxvnni */
  OPT_mbmi = 1721,                           /* -mbmi */
  OPT_mbmi2 = 1722,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1723,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1724,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1725,                    /* -mcet-switch */
  OPT_mcld = 1726,                           /* -mcld */
  OPT_mcldemote = 1727,                      /* -mcldemote */
  OPT_mclflushopt = 1728,                    /* -mclflushopt */
  OPT_mclwb = 1729,                          /* -mclwb */
  OPT_mclzero = 1730,                        /* -mclzero */
  OPT_mcmodel_ = 1731,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1732, */                    /* -mcpu= */
  ...
  OPT_mtls_direct_seg_refs = 1848,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1849,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1850,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1851,                         /* -mtune= */
  OPT_muintr = 1852,                         /* -muintr */
  OPT_mvaes = 1853,                          /* -mvaes */
  OPT_mveclibabi_ = 1854,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1855,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1856,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1857,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1858,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1859,                      /* -mwbnoinvd */
  OPT_mwidekl = 1860,                        /* -mwidekl */
  OPT_mx32 = 1861,                           /* -mx32 */
  OPT_mxop = 1862,                           /* -mxop */
  OPT_mxsave = 1863,                         /* -mxsave */
  OPT_mxsavec = 1864,                        /* -mxsavec */
  OPT_mxsaveopt = 1865,                      /* -mxsaveopt */
  OPT_mxsaves = 1866,                        /* -mxsaves */
  OPT_n = 1867,                              /* -n */
  ...
  OPT_o = 1880,                              /* -o */
  OPT_objects = 1881,                        /* -objects */
  OPT_p = 1882,                              /* -p */
  OPT_pass_exit_codes = 1883,                /* -pass-exit-codes */
  /* OPT_pedantic = 1884, */                 /* -pedantic */
  OPT_pedantic_errors = 1885,                /* -pedantic-errors */
  OPT_pg = 1886,                             /* -pg */
  OPT_pie = 1887,                            /* -pie */
  OPT_pipe = 1888,                           /* -pipe */
  OPT_print_file_name_ = 1889,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1890,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1891,          /* -print-multi-directory */
  OPT_print_multi_lib = 1892,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1893,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1894,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1895,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1896,               /* -print-prog-name= */
  OPT_print_search_dirs = 1897,              /* -print-search-dirs */
  OPT_print_sysroot = 1898,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1899,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1900,                    /* -print-value */
  OPT_quiet = 1901,                          /* -quiet */
  OPT_r = 1902,                              /* -r */
  OPT_remap = 1903,                          /* -remap */
  OPT_reverse_sort = 1904,                   /* -reverse-sort */
  OPT_s = 1905,                              /* -s */
  OPT_save_temps = 1906,                     /* -save-temps */
  OPT_save_temps_ = 1907,                    /* -save-temps= */
  OPT_shared = 1908,                         /* -shared */
  OPT_shared_libgcc = 1909,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1910,               /* -shared-libphobos */
  OPT_size_sort = 1911,                      /* -size-sort */
  /* OPT_specs = 1912, */                    /* -specs */
  OPT_specs_ = 1913,                         /* -specs= */
  OPT_static = 1914,                         /* -static */
  OPT_static_libasan = 1915,                 /* -static-libasan */
  OPT_static_libgcc = 1916,                  /* -static-libgcc */
  OPT_static_libgfortran = 1917,             /* -static-libgfortran */
  OPT_static_libgo = 1918,                   /* -static-libgo */
  OPT_static_libhwasan = 1919,               /* -static-libhwasan */
  OPT_static_liblsan = 1920,                 /* -static-liblsan */
  OPT_static_libmpx = 1921,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1922,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1923,               /* -static-libphobos */
